...
public class Ligue implements Serializable, Comparable<Ligue> {
    ...
    /**
     * Fait de administrateur l'administrateur de la ligue. Lève
     * DroitsInsuffisants si l'administrateur n'est pas un employé de la ligue
     * ou le root. Révoque les droits de l'ancien administrateur.
     *
    ...
    /**
     * Ajoute un employé dans la ligue. Cette méthode est le seul moyen de créer
     * un employé.
     *
    ...
    public Employe addEmploye(String nom, String prenom, String mail, String password, LocalDate dateArrivee,
        ...
        Employe employe = new Employe(this.gestionPersonnel, this, id, nom, prenom, mail, password, dateArrivee,
                dateDepart);
    ...
    /**
     * Supprime la ligue, entraîne la suppression de tous les employés de la
     * ligue.
     */
    public void remove() {
